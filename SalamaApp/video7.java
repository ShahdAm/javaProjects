 ...
 * @author noof9
 */
public class video7 implements Initializable {
 @FXML
private MediaView video7;
@FXML
private Button play7,pause7,reset7;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/broken.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video7.setMediaPlayer(mp);
    }
