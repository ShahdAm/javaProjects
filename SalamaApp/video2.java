 ...
 * @author noof9
 */
public class video2 implements Initializable{
@FXML
private MediaView video2;
@FXML
private Button play2,pause2,reset2;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/bleeding.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video2.setMediaPlayer(mp);
    }
