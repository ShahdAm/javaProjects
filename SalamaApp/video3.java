 ...
 * @author noof9
 */
public class video3 implements Initializable {
 @FXML
private MediaView video3;
@FXML
private Button play3,pause3,reset3;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/stroke.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video3.setMediaPlayer(mp);
    }
