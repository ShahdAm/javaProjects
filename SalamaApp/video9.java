 ...
 * @author noof9
 */
public class video9 implements Initializable {
 @FXML
private MediaView video9;
@FXML
private Button play9,pause9,reset9;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/seizure.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video9.setMediaPlayer(mp);
    }
