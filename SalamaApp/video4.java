 ...
 * @author noof9
 */
public class video4 implements Initializable {
 @FXML
private MediaView video4;
@FXML
private Button play4,pause4,reset4;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/burns.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video4.setMediaPlayer(mp);
    }
