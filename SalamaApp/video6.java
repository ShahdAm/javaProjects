 ...
 * @author noof9
 */
public class video6 implements Initializable {
 @FXML
private MediaView video6;
@FXML
private Button play6,pause6,reset6;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/CPR.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video6.setMediaPlayer(mp);
    }
