 ...
 * @author noof9
 */
public class video8 implements Initializable {
 @FXML
private MediaView video8;
@FXML
private Button play8,pause8,reset8;
@FXML
    ImageView back;
...
private MediaPlayer mp;
    ...
    public void initialize(URL location, ResourceBundle resources) {
     ...
     String vurl="file:/C:/Users/noof9/Documents/NetBeansProjects/FXProject/projectAP/src/projectap/video/fire.mp4";
      media= new Media(vurl);
      mp= new MediaPlayer(media);
      video8.setMediaPlayer(mp);
    }
